...
export JOB_TO_RUN="com.oboturov.ht.stage2.NupletsWithKeywordsProcessedSplitter"
export JOB_CONFIG="${TP_TWITTER_PROJECT_BASE_DIR}/hadoop-configs/hadoop-personal-server-local.xml"
export INPUT_FILE_DIR="keywords-processed-nuplets"
export INPUT_FILE_NAME="keywords-processed-nuplets-2009-$1"
export OUTPUT_FILE_NAME="nuplets-with-keywords-split-2009-$1"
