...
export JOB_TO_RUN="com.oboturov.ht.stage3.SeparateShortenedAndFullURIProcessor"
export JOB_CONFIG="${TP_TWITTER_PROJECT_BASE_DIR}/hadoop-configs/hadoop-personal-server-local.xml"
export INPUT_FILE_DIR="nuplets-with-keywords-split"
export INPUT_FILE_NAME="nuplets-with-keywords-split-2009-$1"
export OUTPUT_FILE_NAME="uris-separated-to-full-and-shortened-2009-$1"
export INPUT_FILES_LIST="`ls -m ${INPUT_DATA_DIR}/${INPUT_FILE_DIR}/${INPUT_FILE_NAME}/nupletsrequiringurisresolution*.bz2`"
